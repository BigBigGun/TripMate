...
// 刷新数据url
#define URLSTR(a,b) [NSString stringWithFormat:@"http://api.breadtrip.com/destination/place/%@/%@/pois/mall/?start=0&count=20&sort=default&shift=false&latitude=23.1775696956738&longitude=113.34044121755221",self.type,self.cityID]


#define URLSTRING(a,b,c) [NSString stringWithFormat:@"http://api.breadtrip.com/destination/place/%@/%@/pois/mall/?start=0&count=%d&sort=default&shift=false&latitude=23.1775696956738&longitude=113.34044121755221",self.type,self.cityID,self.flag]
...
@interface ItineraryViewController ()<NetWorkToolDelegate,UITableViewDelegate,UITableViewDataSource,MJRefreshBaseViewDelegate>
...
-(void)backMalls:(NSString *)cityID type:(NSString *)type{
